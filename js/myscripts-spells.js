...
var cleric6 = ['Запрет (КИ)', 'Истинное зрение (КИ)', 'Пир героев (КИ)', 'Планарный союзник (КИ)', 'Поиск пути (КИ)', 'Полное исцеление (КИ)', 'Поражение (КИ)', 'Слово возврата (КИ)', 'Солнечный луч (КИ)', 'Сотворение нежити (КИ)', 'Стена клинков (КИ)','Панихида (ГФ)','Священная звезда Мистры (ГФ)']
