...
var cleric6 = ['Запрет (КИ)', 'Истинное зрение (КИ)', 'Пир героев (КИ)', 'Планарный союзник (КИ)', 'Поиск пути (КИ)', 'Полное исцеление (КИ)', 'Поражение (КИ)', 'Слово возврата (КИ)', 'Солнечный луч (КИ)', 'Сотворение нежити (КИ)', 'Стена клинков (КИ)','Панихида (ГФ)']
...
var cleric8 = ['Аура святости (КИ)', 'Власть над погодой (КИ)', 'Землетрясение (КИ)', 'Поле антимагии (КИ)', 'Солнечный ожог (КИ)','Священная звезда Мистры (ГФ)']
...
var druid5 = ['Вызов элементаля (КИ)', 'Высшее восстановление (КИ)', 'Древесный путь (КИ)', 'Заражение (КИ)', 'Конус холода (КИ)', 'Множественное лечение ран (КИ)', 'Наблюдение (КИ)', 'Нашествие насекомых (КИ)', 'Обет (КИ)', 'Общение с природой (КИ)', 'Планарные узы (КИ)', 'Преграда жизни (КИ)', 'Пробуждение разума (КИ)', 'Реинкарнация (КИ)', 'Стена камня (КИ)','Лунный плащ Алустриэль (ГФ)','Стихийное насыщение Сонгал (ГФ)']
var druid6 = ['Вызов феи (КИ)', 'Движение почвы (КИ)', 'Окаменение (КИ)', 'Пир героев (КИ)', 'Поиск пути (КИ)', 'Полное исцеление (КИ)', 'Путешествие через растения (КИ)', 'Солнечный луч (КИ)', 'Стена шипов (КИ)', 'Хождение по ветру (КИ)','Лучезарные сферы Эльминстера (ГФ)']
...
var ranger5 = ['Быстрый колчан (КИ)', 'Вызов залпа (КИ)', 'Высшее восстановление (КИ)', 'Древесный путь (КИ)', 'Общение с природой (КИ)', 'Удар стального ветра (КИ)','Лунный плащ Алустриэль (ГФ)']

var paladin1 = ['Благословение (КИ)', 'Божественная кара (КИ)', 'Божественное благоволение (КИ)', 'Вызов на дуэль (КИ)', 'Героизм (КИ)', 'Гневная кара (КИ)', 'Громовая кара (КИ)', 'Защита от зла и добра (КИ)', 'Лечение ран (КИ)', 'Обнаружение болезней и яда (КИ)', 'Обнаружение добра и зла (КИ)', 'Обнаружение магии (КИ)', 'Очищение пищи и питья (КИ)', 'Палящая кара (КИ)', 'Приказ (КИ)', 'Щит веры (КИ)', 'Отводящий снаряд (ГФ)']
...
var sorcerer1 = ['Безмолвный образ (КИ)', 'Ведьмин снаряд (КИ)', 'Волна грома (КИ)', 'Волшебная стрела (КИ)', 'Доспехи мага (КИ)', 'Ледяной кинжал (КИ)', 'Луч болезни (КИ)', 'Маскировка (КИ)', 'Обнаружение магии (КИ)', 'Огненные ладони (КИ)', 'Очарование личности (КИ)', 'Падение пёрышком (КИ)', 'Понимание языков (КИ)', 'Поспешное отступление (КИ)', 'Прыжок (КИ)', 'Псевдожизнь (КИ)', 'Сверкающие брызги (КИ)', 'Скольжение (КИ)', 'Туманное облако (КИ)', 'Усыпление (КИ)', 'Цветной шарик (КИ)', 'Щит (КИ)', 'Вспышка чаропламени (ГФ)']
var sorcerer2 = ['Видение невидимого (КИ)', 'Внушение (КИ)', 'Воображаемая сила (КИ)', 'Глухота/слепота (КИ)', 'Горящий клинок (КИ)', 'Дребезги (КИ)', 'Дыхание дракона (КИ)', 'Корона безумия (КИ)', 'Левитация (КИ)', 'Магическое здоровье (КИ)', 'Магическое оружие (КИ)', 'Невидимость (КИ)', 'Облако кинжалов (КИ)', 'Обнаружение мыслей (КИ)', 'Отражения (КИ)', 'Палящий луч (КИ)', 'Паук (КИ)', 'Паутина (КИ)', 'Порыв ветра (КИ)', 'Почтовое животное (КИ)', 'Пронзание разума (КИ)', 'Пылающая сфера (КИ)', 'Размытый образ (КИ)', 'Смена обличья (КИ)', 'Стук (КИ)', 'Туманный шаг (КИ)', 'Тьма (КИ)', 'Тёмное зрение (КИ)', 'Увеличение/уменьшение (КИ)', 'Удержание личности (КИ)', 'Улучшение характеристики (КИ)','Доспехи смерти (ГФ)']
var sorcerer3 = ['Газообразная форма (КИ)', 'Гипнотический узор (КИ)', 'Дневной свет (КИ)', 'Замедление (КИ)', 'Защита от энергии (КИ)', 'Зловонное облако (КИ)', 'Контрзаклинание (КИ)', 'Мерцание (КИ)', 'Метель (КИ)', 'Молния (КИ)', 'Образ (КИ)', 'Огненный шар (КИ)', 'Подводное дыхание (КИ)', 'Подсматривание (КИ)', 'Полёт (КИ)', 'Прикосновение вампира (КИ)', 'Рассеивание магии (КИ)', 'Ужас (КИ)', 'Ускорение (КИ)', 'Хождение по воде (КИ)', 'Языки (КИ)','Серебряное копьё Лаэрали (ГФ)','Щит какофонии (ГФ)']
var sorcerer4 = ['Высшая невидимость (КИ)', 'Град (КИ)', 'Едкий шар (КИ)', 'Изгнание (КИ)', 'Каменная кожа (КИ)', 'Огненный щит (КИ)', 'Очарование монстра (КИ)', 'Переносящая дверь (КИ)', 'Подчинение зверя (КИ)', 'Превращение (КИ)', 'Смятение (КИ)', 'Стена огня (КИ)', 'Усыхание (КИ)', 'Буря чаропламени (ГФ)','Ответный урон (ГФ)']
var sorcerer5 = ['Длань Бигби (КИ)', 'Конус холода (КИ)', 'Круг телепортации (КИ)', 'Нашествие насекомых (КИ)', 'Облако смерти (КИ)', 'Оживление вещей (КИ)', 'Подчинение личности (КИ)', 'Притворство (КИ)', 'Синаптический разряд (КИ)', 'Сотворение (КИ)', 'Стена камня (КИ)', 'Телекинез (КИ)', 'Удержание чудовища (КИ)','Стихийное насыщение Сонгал (ГФ)']
var sorcerer6 = ['Движение почвы (КИ)', 'Истинное зрение (КИ)', 'Круг смерти (КИ)', 'Магические врата (КИ)', 'Множественное внушение (КИ)', 'Окаменение (КИ)', 'Отилюков ледяной шар (КИ)', 'Разящее око (КИ)', 'Распад (КИ)', 'Солнечный луч (КИ)', 'Сфера неуязвимости (КИ)', 'Цепная молния (КИ)','Лучезарные сферы Эльминстера (ГФ)']
var sorcerer7 = ['Замедленный огненный шар (КИ)', 'Изменение тяготения (КИ)', 'Огненная буря (КИ)', 'Перст смерти (КИ)', 'Радужные брызги (КИ)', 'Телепортация (КИ)', 'Уход в иной план (КИ)','Синостодвеомер Симбул (ГФ)']
...
var sorcerer9 = ['Врата (КИ)', 'Желание (КИ)', 'Метеоритный дождь (КИ)', 'Остановка времени (КИ)', 'Слово силы: смерть (КИ)','Клинок разрушения (ГФ)']
...
var warlock4 = ['Изгнание (КИ)', 'Мираж (КИ)', 'Очарование монстра (КИ)', 'Переносящая дверь (КИ)', 'Призыв духа аберрации (КИ)', 'Усыхание (КИ)', 'Гибельная волна (ГФ)','Ответный урон (ГФ)']
